...
import { useGlobalConfig, useLocale } from '@lt13.10/hooks'
import Chinese from '@lt13.10/locale/lang/zh-cn'
import English from '@lt13.10/locale/lang/en'
import { ElButton, ElMessage } from '@lt13.10/components'
